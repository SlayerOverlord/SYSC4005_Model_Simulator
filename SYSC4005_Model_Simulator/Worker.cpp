...
std::vector<struct event_data_st> Worker::departEvent(struct event_data_st event_given)
{
...
std::vector<struct event_data_st> Worker::notamEvent(struct event_data_st event_given)
{
	if (this->state.idle) {
		this->state.idle = 0;
